<?php  
// INSERT INTO `CRUD` (`sno`, `title`, `description`, `tstamp`) VALUES (NULL, 'But Books', 'Please buy books from Store', current_timestamp());
$insert = false;
$update = false;
$delete = false;
...
if(isset($_GET['delete'])){
  $sno = $_GET['delete'];
  $delete = true;
  $sql = "DELETE FROM `CRUD` WHERE `srno` = $sno";
...
if (isset( $_POST['snoEdit'])){
  ...
  $sql = "UPDATE `CRUD` SET `Title` = '$title' , `Description` = '$description' WHERE `CRUD`.`srno` = $sno";
  $result = mysqli_query($conn, $sql);
  if($result){
    $update = true;
}
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this note!")) {
          console.log("yes");
          window.location = `/Kaushal/CRUD/index.php?delete=${sno}`;
