...
<body>
    ...
    if($method=='POST'){
        ...
        $sql="INSERT INTO `discussion` (`Discussion_id`, `Discussion_content`, `Thread_id`, `Discussion_by`, `Discussion_time`) VALUES ('', '$comment', '$id', '0', current_timestamp())"; 
    $result = mysqli_query($conn,$sql);
    $showAlert = true;
    if($showAlert){
        echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
  <strong>Sucsess!</strong> Your Have been Added.
